...
async def draw_music_info(
    ...
    mr.draw(600, 1212, 22, f'Designed by Sakurahane. Generated by {get_botname()} ', default_color, 'mm')
...
async def draw_music_play_data(qqid: int, music_id: str) -> Union[str, MessageSegment]:
    ...
    try:
        ...
        cover = Image.open(cover_path).convert("RGBA").resize((300, 300))
        ...
        mr.draw(600, 827, 22, f'Designed by Sakurahane. Generated by {get_botname()} ', color, 'mm')
